...
- **closed**：cpp-01(B,83db5ff)、cpp-02(C,c19a351)、cpp-03(D,16f1948)、cpp-04(E,6f3d734)、cpp-05(G,3f0ed41)、cpp-06(H,a096b52)、cpp-07(K,2755fe3)、cpp-08(M,4d93a66)、cpp-09(N,754b437)、cpp-0a(Q,f8f0044)、cpp-0b(R,93ab4b4)、cpp-0c(S,f8f0044)、cpp-0d(T,f8f0044)、cpp-0e(Z/U,2be27a7 LIR+e4a885c+00ed62b MIR 后端,empty_class_value.cc 双路径闭环)、cpp-0f(Y,9e43494)、c-00(W,604be9e)、c-01(X,e9fae35)、mir-00(F,647a05b)、mir-01(V,93ab4b4+4c24bfe)、x86-00(va_list,222a28d)、range-for(71fbb35)
- **open**：（第二批缺陷已全 closed，队列清空）
