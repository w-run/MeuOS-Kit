...
| as-full-isa | mt/as | 全架构指令完整覆盖 | 各架构缺的少用指令补全（ARM 从 321→831 行，含乘累加/位域/位反转/VFP全系列/NEON基础/DSP/除法/多寄存器存取/提示指令等） | 🟡 | ARM 编码完善（831 行，仍有 NEON/Thumb 待完善）；x86_64 1075 行最完整 |
