...
| as-full-isa | mt/as | 全架构指令完整覆盖 | 各架构缺的少用指令补全（ARM 从 321→715 行，含除法/64位乘/字节反转/VFP全系列/符号扩展/rbit/sel/NEON基础/多寄存器存取/pld） | 🟡 | ARM 编码完善（715 行，仍有 NEON 待完善）；x86_64 1075 行最完整 |
