...
| grace | lite | worktree-tmp-grace-cpp23 + worktree-tmp-grace-cpprest (自 worktree-mxx-work@fc1f279) | /tmp/mxx-wt-grace | sema/decl E1/E4/E5/E6 + C++23 缺口 + **C++ 剩余缺口：依赖类型 NTTP / constexpr 返回类对象 / consteval 模板边界** | **completed**（cpp23 已合入 ba6d9f8；cpprest ef89d22+3ae5a04+d061167 已 push worktree-tmp-grace-cpprest，verify-all 双模式 19/19） | push worktree-tmp-grace-cpprest |
