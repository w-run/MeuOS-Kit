...
| bella | lite | worktree-tmp-bella-perf (自 worktree-mxx-work@43d1507) | /tmp/mxx-wt-bella | x86_64 MIR-native + Phase 3a riscv64 + Phase 3b loongarch64（#117 试点 + #141 全功能）+ MIR 机器层性能优化（#156） | **completed**（#94/#97/#111/#117/#141 已合入；#156：a7dc321 regalloc spill-either（6.6×）+ 628f17b load 转发/DCE 不动点（-33% asm）+ 3ebd775 O3 sdiv 强度削减（idiv 4→0），已 push worktree-tmp-bella-perf，verify-all 19/19） | 9d8981e |
