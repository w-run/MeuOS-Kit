...
| diana | lite | worktree-tmp-diana-errcode2 (自 worktree-mxx-work) | /tmp/mxx-wt-diana | C23/C11 边界测试 + check-pic-verify + 错误码体系/多错收集 + DWARF 调试信息 + **错误码全覆盖批量补码（E0005-E0012，~400 站点）** | **completed**（C23/PIC/errcode/dwarf/dwarfloc/fastmath 均已合入主线；errcode2 29de481/d08b136/4c3c8c9/a4a2eff/481110f/a421749/e72cfea 已 push） | 11 test/c23 + GOT + E#### + DWARF4 + 错误码全覆盖 |
