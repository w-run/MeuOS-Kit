...
| [feedback_shared_worktree_concurrency.md](feedback_shared_worktree_concurrency.md) | 共享 worktree 上 reset/stash 会与并发进程交错；先查 ps/reflog 再操作 |
...
| [feedback_notify_https.md](feedback_notify_https.md) | notify icon/url 参数须 https://box.w-run.net 绝对路径 |
| [feedback_notify_icon_encoding.md](feedback_notify_icon_encoding.md) | push.py 对 icon 不编码致 Bark 404；须 quote(safe="") 或 curl --data-urlencode |
| [feedback_notify_body_noslash.md](feedback_notify_body_noslash.md) | notify 正文注意事项 |
| [feedback_notify.md](feedback_notify.md) | 长任务里程碑用 notify 推送（图标 meuos_icon、分组 meuos-kernel） |
...
| [project_cpp_remaining_gaps.md](project_cpp_remaining_gaps.md) | 依赖类型 NTTP/constexpr 返回类对象/consteval 模板边界 |
...
| [project_mxx_worktrees.md](project_mxx_worktrees.md) | mcc/m++ 团队 worktree 布局与并发教训 |
