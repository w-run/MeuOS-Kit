...
static const char version[] = "0.1.0-fold (meuos-utils)";

int main(int argc, char **argv) {
    if (argc > 1 && !strcmp(argv[1], "--version")) { printf("fold %s\n", version); return 0; }
    if (argc > 1 && !strcmp(argv[1], "--help")) { printf("Usage: fold [-w WIDTH] [-b] [-s] [FILE]...\n"); return 0; }
    int width = 80, bytes = 0, breaks = 0, argi = 1;
