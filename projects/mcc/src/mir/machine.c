...
mmop_name(MMOP op)
{
	static const char *names[MMOP_NOP] = {
		...
		[MMOP_CVTTSS2SQ]= "cvttss2sq",
		[MMOP_CVTTSD2SQ]= "cvttsd2sq",
		[MMOP_CVTTSS2SI_U]= "cvttss2si_u",
		[MMOP_CVTTSD2SI_U]= "cvttsd2si_u",
		[MMOP_CVTTSS2SQ_U]= "cvttss2sq_u",
		[MMOP_CVTTSD2SQ_U]= "cvttsd2sq_u",
		[MMOP_LOAD]     = "load",
