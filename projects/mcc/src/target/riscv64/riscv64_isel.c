...
fixarg(Ref *r, int k, Ins *i, Fn *fn)
{
	...
	case RTmp:
		...
		/* Load/store addresses are XLEN GPRs regardless of the operation's
		 * data class.  VLA and aggregate addresses reach this path as Kl
		 * temporaries rather than stack slots. */
